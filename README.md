...
|Item|Respuesta|
|----|-------|
|Nombre de proyecto|marketingtool2|
|Descripción|Creacion de base de datos. Existen **dos componentes** principales, el **sensor** de rayería y el dispositivo de **alerta**|
